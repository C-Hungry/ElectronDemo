        ...
        <div class="base-login-regist">
          <Dropdown trigger="click">
            ...
            <DropdownMenu slot="list">
              ...
              <DropdownItem><router-link to="/shipper/notice" style="font-size: 15px; color: #666;">通知消息</router-link></DropdownItem>
...
export default {
  ...
  methods: {
    ...
    openDetail(data) {
      ...
      switch(type) {
        ...
        case 5:
          ...
          break;
        case 7:
          this.$router.push('/shipper/transportmanager');
          break; 
        case 8:
          this.$router.push('/shipper/transportmanager');
          break; 
    ...
    // 跳转至消息
    toMyNotice() {
      this.$router.push('/shipper/notice');
    },
    // 读取未读消息个数
    getBadgeNumber(){
